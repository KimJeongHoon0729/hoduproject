				...
				<form id="reservation" action="${path }/RInsert.do?pensionName=${param.pensionName }">
					<div class="col-md-6 col-md-offset-3">
						...
						<div class="form-group ">
							<p style="text-align: left; margin-bottom: 0px">예약 시작 날짜</p>
							<label for="reservation_Sdate" class="sr-only">reservation_Sdate</label> <input id="reservation_Sdate" name="reservation_Sdate"
								class="form-control" placeholder="예약 시작 날짜" type="date">
							<p style="text-align: left; margin-bottom: 0px">예약 종료 날짜</p>
							<label for="reservation_Edate" class="sr-only">reservation_Edate</label> <input id="reservation_Edate" name="reservation_Edate"
								class="form-control" placeholder="예약 종료 날짜" type="date">
						</div>
						<div class="form-group ">
							<label for="userId" class="sr-only">userID</label> <input id="userId" name="userId" class="form-control" value="${sessionScope.userId }"
								placeholder="아이디" type="hidden">
						</div>
						...
						<div class="form-group ">
							<label for="userName" class="sr-only">userName</label> <input id="userName" name="userName" class="form-control" placeholder="이름" type="text">
						</div>
						<div class="form-group ">
							<label for="userMobile" class="sr-only">userMobile</label> <input id="userMobile" name="userMobile" class="form-control" placeholder="핸드폰 번호"
								type="text">
						</div>
						<div class="form-group ">
							<label for="userEmail" class="sr-only">userEmail</label> <input id="userEmail" name="userEmail" class="form-control" placeholder="이메일"
								type="text">
						</div>
						<div class="form-group ">
						...
						<div class="form-control" style="margin-bottom: 15px">
							...
							<p style="font-size: 16px">
								<input type='checkbox' name='dogSize' value='소형견' /> 소형견 (10Kg 미만)&nbsp;&nbsp;&nbsp; <input type='checkbox' name='dogSize' value='중형견' />
								중형견 (10kg~25Kg 미만)&nbsp;&nbsp;&nbsp; <input type='checkbox' name='dogSize' value='대형견' /> 대형견 (25Kg 이상)
							</p>
						</div>
						<div class="form-group ">
