		  ...
		  <form id="user" action="signin.do" name="join_form" method="post">
                ...
                <div class="col-md-6 col-md-offset-3">
                  <div class="form-group">
                     ...
                     <input id="userId" name="userId" class="form-control" placeholder="아이디" type="text">
                    
                  </div>
                   <div class="form-group ">
                     <label for="userPw" class="sr-only">userPw</label>
                     <input id="userPw" name="userPw" class="form-control" placeholder="펜션 이름" type="password">
                  </div>
                  <div class="form-group ">
                     <label for="userPwRe" class="sr-only">userPwRe</label>
                     <input id="userPwRe"  class="form-control" placeholder="제목" type="password" >
                  </div>
                   <div class="form-group ">
