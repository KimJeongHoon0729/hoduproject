...
public class ReservationVO {
	...
	Date reservation_Sdate;
	@DateTimeFormat(pattern = "yyyy-MM-dd")
	Date reservation_Edate;
	String partnerId;
	String roomName;
	...
	public Date getReservation_Sdate() {
		return reservation_Sdate;
	}

	public void setReservation_Sdate(Date reservation_Sdate) {
		this.reservation_Sdate = reservation_Sdate;
	}

	public Date getReservation_Edate() {
		return reservation_Edate;
	}

	public void setReservation_Edate(Date reservation_Edate) {
		this.reservation_Edate = reservation_Edate;
	}
	...
	public String toString() {
		return "ReservationVO [reservation_idx=" + reservation_idx + ", userId=" + userId + ", userName=" + userName
				...
				+ ", message_to_p=" + message_to_p + ", reservation_Sdate=" + reservation_Sdate + ", reservation_Edate="
				+ reservation_Edate + ", partnerId=" + partnerId + ", roomName=" + roomName + "]";
	}
